...
namespace mvcEF.Controllers
{
    public class DrivesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDDrive,Name,Memory,Description,Price")] Drive drive)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDDrive,Name,Memory,Description,Price")] Drive drive)
        {
            if (ModelState.IsValid)
            {
